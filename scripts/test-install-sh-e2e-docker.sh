...
<<<<<<< HEAD
IMAGE_NAME="${MOLTBOT_INSTALL_E2E_IMAGE:-moltbot-install-e2e:local}"
...
<<<<<<< HEAD
MOLTBOT_E2E_MODELS="${MOLTBOT_E2E_MODELS:-}"
=======
...
<<<<<<< HEAD
  ...
  -e MOLTBOT_INSTALL_TAG="${MOLTBOT_INSTALL_TAG:-latest}" \
  -e MOLTBOT_E2E_MODELS="$MOLTBOT_E2E_MODELS" \
  -e MOLTBOT_INSTALL_E2E_PREVIOUS="${MOLTBOT_INSTALL_E2E_PREVIOUS:-}" \
  -e MOLTBOT_INSTALL_E2E_SKIP_PREVIOUS="${MOLTBOT_INSTALL_E2E_SKIP_PREVIOUS:-0}" \
=======
